...
from core.auth import NotAuthenticatedException
...
from api.routers import patients, interns, appointments, views, reports, settings as settings_router, waiting_list, fitting_list, auth
